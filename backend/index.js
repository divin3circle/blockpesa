...
async function handleVerification(req, res) {
  ...
  // https://devs.polygonid.com/docs/smart-contracts/#blockchain-addresses
  const amoyContractAddress = "0x1a4cC30f2aA0377b0c3bc9848766D90cb4404124";
  const keyDIR = "./keys";

  const ethStateResolver = new resolver.EthStateResolver(
    "https://polygon-amoy.g.alchemy.com/v2/CZADxmUkKg93ma_X-e-B0Xo1HC_Z40cy",
    amoyContractAddress
  );
  ...
  try {
    ...
    console.log(
      "Error handling verification: Double check the value of your RPC_URL_POLYGON_AMOY in the .env file. Are you using a valid api key from your RPC provider? Visit https://alchemy.com/?r=zU2MTQwNTU5Mzc2M and create a new app with Polygon Amoy"
    );
